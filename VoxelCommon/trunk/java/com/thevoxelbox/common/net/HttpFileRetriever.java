	...
	public void run()
	{
		...
		try
		{
			try
			{
				...
				http.addRequestProperty("User-Agent", "Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.0)"); // For CloudFlare
				...
				if (this.cancelled)
				{
					if (this.progressWatcher != null) this.progressWatcher.onCompleted();
