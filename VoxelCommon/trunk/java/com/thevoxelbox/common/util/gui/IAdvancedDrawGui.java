...
public interface IAdvancedDrawGui
{
	 ...
	 */
	public abstract void drawTessellatedModalBorderRect(ResourceLocation texture, int textureSize, int x, int y, int x2, int y2, int u, int v, int u2, int v2, int borderSize);
	 ...
	 * @param borderSize Number of pixels to leave unstretched, must be less than half of the width or height (whichever is smallest)
	 */
	public abstract void drawTessellatedModalBorderRect(ResourceLocation texture, int textureSize, int x, int y, int x2, int y2, int u, int v, int u2, int v2, int borderSize, boolean setcolor);
	 ...
	 * @param v2 Bottom edge V coordinate
	 */
	public abstract void drawTexturedModalRect(ResourceLocation texture, int x, int y, int x2, int y2, int u, int v, int u2, int v2);
