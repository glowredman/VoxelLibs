...
//	protected GuiScreenEx parentScreenEx;
	...
	/**
	 * Close the dialog box and display the parent screen (if it is available, otherwise clear the gui)
	 */
	...
	/* (non-Javadoc)
	 * @see net.eq2online.macros.gui.shared.GuiScreenEx#mouseClicked(int, int, int)
	 */
	@Override
	protected final void mouseClicked(int mouseX, int mouseY, int button)
	{
		if (button == 0 && this.movable && mouseX > this.dialogX && mouseX < this.dialogX + this.dialogWidth && mouseY > this.dialogY - 18 && mouseY < this.dialogY)
		{
	...
	/* (non-Javadoc)
	 * @see net.eq2online.macros.gui.shared.GuiScreenEx#mouseMovedOrUp(int, int, int)
	 */
	@Override
	...
	public final void initGui()
	{
		...
		// Call to owner since the owner is still drawn whilst we are being displayed
		...
		this.btnOk     = new GuiButton(-1, this.dialogX + this.dialogWidth - 62, this.dialogY + this.dialogHeight - 22, 60, 20, I18n.format("gui.done"));
		this.btnCancel = new GuiButton(-2, this.dialogX + this.dialogWidth - 124, this.dialogY + this.dialogHeight - 22, 60, 20, I18n.format("gui.cancel"));
	...
	/**
	 * Stub for subclasses, perform any tasks required when the dialog is validated and about to be submitted 
	 */
	public abstract void onSubmit();
	
	/**
	 * Stub for subclasses, return true if the dialog can be submitted in its current state, or false to prevent submission
	 * 
	 * @return
	 */
