...
public class VoxelPropertySliderOld extends VoxelProperty<IVoxelPropertyProviderFloat>
{
	...
	public VoxelPropertySliderOld(IVoxelPropertyProvider propertyProvider, String binding, String displayText, String minText, String maxText, int xPos, int yPos, float min, float max)
	{
	...
	public VoxelPropertySliderOld(IVoxelPropertyProvider propertyProvider, String binding, String displayText, int xPos, int yPos, float min, float max)
	{
		this(propertyProvider, binding, displayText, xPos, yPos);
	}
	
	public VoxelPropertySliderOld(IVoxelPropertyProvider propertyProvider, String binding, String displayText, String minText, String maxText, int xPos, int yPos)
	{
		this(propertyProvider, binding, displayText, xPos, yPos);
	...
	public VoxelPropertySliderOld(IVoxelPropertyProvider propertyProvider, String binding, String displayText, int xPos, int yPos)
	{
	...
	public void draw(IAdvancedDrawGui host, int mouseX, int mouseY)
	{
		...
		this.overBar = this.mouseIn(mouseX, mouseY, sliderLeft, sliderYPos, sliderRight, sliderYPos2) && !this.overSlide;
		...
		if (this.offset > sliderMaxX) this.offset = sliderMaxX;
		if (this.offset < sliderMinX) this.offset = sliderMinX;
		
		drawRect(sliderXPos2 - 1 + this.offset, sliderYPos2 - 1, sliderXPos + 1 + this.offset, sliderYPos + 1, 0xFF000000);
		host.drawTessellatedModalBorderRect(LiteModVoxelCommon.GUIPARTS, 256, (sliderXPos + this.offset), sliderYPos, (sliderXPos2 + this.offset), sliderYPos2, 0, (this.overSlide || this.dragging) ? 16 : 0, 16, (this.overSlide || this.dragging) ? 32 : 16, 4);
	}
