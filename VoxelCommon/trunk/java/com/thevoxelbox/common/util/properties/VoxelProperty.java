...
public abstract class VoxelProperty<PropertyType extends IVoxelPropertyProvider> extends Gui
{
	...
	public VoxelProperty(IVoxelPropertyProvider propertyProvider, String binding, String displayText, int xPos, int yPos)
	{
		try
		{
	 ...
	 * @param mouseY
	 */
	public abstract void draw(IAdvancedDrawGui host, int mouseX, int mouseY);
