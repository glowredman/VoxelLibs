...
public class VoxelPropertyIntField extends VoxelPropertyAbstractTextField<IVoxelPropertyProviderInteger>
{
	...
	public VoxelPropertyIntField(IVoxelPropertyProvider propertyProvider, String binding, String text, int xPos, int yPos, int fieldOffset)
	{
	...
	{
		if (this.fieldValue.length() == 0) this.fieldValue = this.propertyProvider.getDefaultPropertyValue(this.propertyBinding);
		if (Integer.valueOf(this.fieldValue) < this.minFieldValue) this.fieldValue = String.valueOf(this.minFieldValue);
