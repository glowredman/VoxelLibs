...
public abstract class VoxelPropertyAbstractTextField<PropertyType extends IVoxelPropertyProvider> extends VoxelProperty<PropertyType>
{
	...
	{
		drawRect(this.xPosition + this.fieldOffset + this.fieldWidth, this.yPosition + this.fieldHeight, this.xPosition + this.fieldOffset, this.yPosition - 1, this.focused ? 0xFFFFFFFF : 0xFF999999);
		drawRect(this.xPosition + this.fieldOffset + this.fieldWidth - 1, this.yPosition + this.fieldHeight - 1, this.xPosition + this.fieldOffset + 1, this.yPosition, 0xFF000000);
		...
		this.drawString(this.fontRenderer, this.fieldValue + (optionCursor ? "_" : ""), this.fieldValue.length() > 0 ? (this.xPosition + this.fieldOffset + (this.fieldWidth / 2)) - (this.fontRenderer.getStringWidth(this.fieldValue) / 2) : this.xPosition + this.fieldOffset + (this.fieldWidth / 2) - 3, this.yPosition + 4, 0xFFFFFF);
	}
	...
	public void keyTyped(char keyChar, int keyCode)
	{
		if (this.focused)
		{
			...
			{
				if (this.fieldValue.indexOf(keyChar) >= 0) return;
				if (this.fieldValue.length() == 0) this.fieldValue += "0";
			}
