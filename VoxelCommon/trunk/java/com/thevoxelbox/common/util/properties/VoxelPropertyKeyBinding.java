...
public class VoxelPropertyKeyBinding extends VoxelProperty<IVoxelPropertyProviderInteger>
{
	 ...
	 * @param yPos
	 */
	public VoxelPropertyKeyBinding(IVoxelPropertyProvider propertyProvider, String binding, String displayText, int xPos, int yPos)
	{
	...
	public void draw(IAdvancedDrawGui host, int mouseX, int mouseY)
	{
		...
		this.drawString(this.fontRenderer, fKey, (this.xPosition + this.buttonOffset + (this.buttonWidth / 2)) - (this.fontRenderer.getStringWidth(fKey) / 2), this.yPosition + 4, overKey || this.focused ? 0xFFFFFF : 0x999999);
	}
	
	/* (non-Javadoc)
	 * @see com.voxelbox.voxelflight.VoxelFlightGUI.VoxelProperty#MouseClicked(int, int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.voxelbox.voxelflight.VoxelFlightGUI.VoxelProperty#KeyTyped(char, int)
	 */
	@Override
