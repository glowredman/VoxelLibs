...
public class SettingsPanelManager implements Tickable
{
	 ...
	 */
	public static KeyBinding guiKeyBinding = new KeyBinding("VoxelMods", Keyboard.KEY_F7, "VoxelLib");
	...
	/* (non-Javadoc)
	 * @see com.mumfrey.liteloader.Tickable#onTick(net.minecraft.src.Minecraft, float, boolean, boolean)
	 */
	@Override
	public void onTick(Minecraft minecraft, float partialTicks, boolean inGame, boolean clock)
	{
		// Handle GUI key being pressed
		if (minecraft.currentScreen == null && guiKeyBinding.getIsKeyPressed() && this.firstPanel != null)
		{
