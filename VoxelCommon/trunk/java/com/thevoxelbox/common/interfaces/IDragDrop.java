...
/**
 * Interface for controls or other objects which support drag/drop sourcing and destination capabilities
 * 
...
public interface IDragDrop
{
	...
	/**
	 * Add the specified target to this object's list of targets and create a mutual (bi-directional) linkage if specified
	 * 
	...
	/**
	 * Remove the specified object from this object's list of targets and this object from the other object's list of targets if specified
	 * 
	 * @param target Drag Target object to remove
