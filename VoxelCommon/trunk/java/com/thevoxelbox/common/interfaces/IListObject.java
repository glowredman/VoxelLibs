...
public interface IListObject
{
	...
	public enum CustomDrawBehaviour
	{
		...
		/**
		 * Custom draw only, no owner draw is performed and the item draws itself
		 */
		FullCustomDraw		
	}
	...
	/**
	 * Callback which is called if GetCustomDrawBegaviour returns CustomDrawExtra or FullCustomDraw
	 * 
	 ...
	 */
	public abstract void drawCustom(boolean iconEnabled, Minecraft minecraft, int mouseX, int mouseY, int xPosition, int yPosition, int width, int height, int updateCounter);
	 ...
	 */
	public abstract boolean mousePressed(boolean iconEnabled, Minecraft minecraft, int mouseX, int mouseY, int xPosition, int yPosition, int width, int height);
	...
	/**
	 * If a custom action was flagged after calling MousePressed, this function is called to retrieve the custom action
	 * 
	 ...
	 */
	public abstract boolean editInPlaceMousePressed(boolean iconEnabled, Minecraft minecraft, int mouseX, int mouseY, int xPosition, int yPosition, int width, int height);
	 ...
	 * @param height control height
	 */
	public abstract void editInPlaceDraw(boolean iconEnabled, Minecraft minecraft, int mouseX, int mouseY, int xPosition, int yPosition, int width, int height, int updateCounter);
