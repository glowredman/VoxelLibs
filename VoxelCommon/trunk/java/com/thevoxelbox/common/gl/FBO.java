...
public class FBO
{
	...
	/**
	 * Width and height for the current frame buffer, used so we know to regenerate it if the frame
	 * size changes
	 */
	 ...
	 * 
	 * @return True if EXT or ARB framebuffer support is available on the hardware
	 */
