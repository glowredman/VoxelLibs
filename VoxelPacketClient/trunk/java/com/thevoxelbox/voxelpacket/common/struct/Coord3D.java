...
public class Coord3D implements Serializable
{
	...
	/**
	 * Create a new Pos3D equivalent to the supplied Vec3D
	 * 
	 * @param vector
	 */
	public Coord3D(Vec3 vector)
	{
	...
	/**
	 * Create a new Pos3D equivalent to the supplied position
	 * 
	 * @param position
	 */
	public Coord3D(MovingObjectPosition position)
	{
