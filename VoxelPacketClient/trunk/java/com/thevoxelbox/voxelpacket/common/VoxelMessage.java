...
public class VoxelMessage
{
	 ...
	 * 
	 * @deprecated will be removed, use accessor instead
	 */
	@Deprecated
	 ...
	 * 
	 * @deprecated will be removed, use hasShortCode() to check for a shortcode, or getShortCode() to return the shortcode
	 */
	@Deprecated
	...
	/**
	 * For the server-side version, not used on client
	 * 
	 * @deprecated will be removed, use accessor instead
	 */
	@Deprecated
	 ...
	 * @throws MessageOverflowException Thrown if the inbound packet has a higher index than the maximum packet specified.
	 */
	public VoxelMessage(IVoxelPacketHandler agent, VoxelPacket packet, EntityPlayer sender) throws MissingEncoderException, MessageOverflowException
	{
		this.agent          = agent;
		this.sender         = sender;
		this.isLocal        = false; 
	...
	{
		return this.sender != null ? this.sender.getCommandSenderName() : "Local";
	}
